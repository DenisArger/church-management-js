...
#### `/youth_poll` - Опрос для молодежного служения

**Назначение**: Создает опрос о посещении молодежного служения на завтра, если такое событие запланировано.
...
**Реализация**: `src/commands/youthPollCommand.ts`
