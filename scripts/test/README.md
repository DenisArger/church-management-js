...
- `bash scripts/test/test-auto-poll-scheduler.sh local|deployed <url>` — планировщики опросов
- `bash scripts/test/test-youth-poll-scheduler.sh check-dev|local|deployed|cron|all ...` — youth poll scheduler
