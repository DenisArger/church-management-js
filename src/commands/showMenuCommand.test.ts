import { executeShowMenuCommand } from "./showMenuCommand";
...
describe("showMenuCommand", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("calls sendMessage with chatId, menu text, reply_markup from buildMainMenu", async () => {
    await executeShowMenuCommand(111, 222);
