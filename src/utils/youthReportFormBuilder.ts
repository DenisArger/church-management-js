...
export const COMMUNICATION_TYPES = [
  ...
  "Общение на МОСТ/домашнем общении",
  "Посещение (встреча)",
  "Не пообщался",
  "Другое",
];
